...
Got It's Hallucination Manager suite of API helps you to detect and manage hallucinations in your AI models.
...
2. Check for the relevance of the response to the user query.
...
[Got It AI's TruthChecker API for RAG applications](https://docs.activefence.com/index.html) can be used in Nemo Guardrails as an output rail out-of-the-box (you need to have the `GOTITAI_API_KEY` environment variable set).
